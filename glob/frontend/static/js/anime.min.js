(function(u, r) {
  ...
  var u = {
        ...
        b = {
          ...
          Elastic: function(a, b) {
            ...
            return -(
              Math.pow(2, 10 * g) *
              Math.sin(
                (2 * (g - (d / (2 * Math.PI)) * Math.asin(1)) * Math.PI) / d
              )
            );
          },
          Back: function(a) {
    ...
    w = function(a, b) {
      if (b in a.style)
        return getComputedStyle(a).getPropertyValue(E(b)) || "0";
    },
    U = function(a, b) {
    ...
    L = function(a, b, c) {
      if (f.col(b))
        return (
          (b = f.rgb(b) ? b : f.hex(b) ? S(b) : f.hsl(b) ? T(b) : void 0), b
        );
      if (p(b)) return b;
      ...
      a.forEach(function(e, d) {
        ...
        return b.forEach(function(b) {
          ...
          if (l) {
            ...
            h.delay =
              (f.fnc(h.delay) ? h.delay(g, d, a.length) : h.delay) / k.speed;
            h.duration =
              (f.fnc(h.duration) ? h.duration(g, d, a.length) : h.duration) /
              k.speed;
            c.push(h);
          }
        });
